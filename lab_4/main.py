...
bg1 = pygame.image.load('lab_4/Assets/background-day.png')
bg2 = pygame.image.load('lab_4/Assets/background-night.png')

bg = random.choice([bg1, bg2])

im_list = [pygame.image.load('lab_4/Assets/pipe-green.png'), pygame.image.load('lab_4/Assets/pipe-red.png')]
pipe_img = random.choice(im_list)

gameover_img = pygame.image.load('lab_4/Assets/gameover.png')
flappybird_img = pygame.image.load('lab_4/Assets/flappybird.png')
flappybird_img = pygame.transform.scale(flappybird_img, (200, 80))

die_fx = pygame.mixer.Sound('lab_4/Sounds/die.wav')
hit_fx = pygame.mixer.Sound('lab_4/Sounds/hit.wav')
point_fx = pygame.mixer.Sound('lab_4/Sounds/point.wav')
swoosh_fx = pygame.mixer.Sound('lab_4/Sounds/swoosh.wav')
...
pipe_pass = False
pipe_frequency = 1600
last_pipe = pygame.time.get_ticks()  # Инициализация времени последней трубы
